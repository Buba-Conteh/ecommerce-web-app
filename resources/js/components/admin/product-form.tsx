...
// Available sizes and colors constants
const AVAILABLE_SIZES = ["XXS", "XS", "S", "M", "L", "XL", "XXL", "XXXL"];
const AVAILABLE_COLORS = ["Black", "White", "Navy", "Burgundy", "Cream", "Camel", "Charcoal", "Beige", "Gray", "Brown", "Red", "Blue", "Green", "Yellow", "Pink", "Purple", "Orange"];
...
export default function ProductForm({
    ...
    const [formData, setFormData] = useState<ProductFormData>({
        ...
        min_stock_quantity: initialData?.min_stock_quantity?.toString() ?? '5',
            ...
            <div className="space-y-6">
                ...
                {displaySuccess && (
                    <div className="mb-6 rounded-lg border border-green-200 bg-green-50 p-4">
                        <p className="text-green-600">{displaySuccess}</p>
                    </div>
                )}
